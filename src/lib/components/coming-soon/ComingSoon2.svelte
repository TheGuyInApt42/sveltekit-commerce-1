...
<section id="coming-soon">
  <h2 class="mb-8 text-center">Coming Soon</h2>
  ...
  <div class="tabset">
    ...
    <div class="tab-panels">
      <section id="PlayStation" class="tab-panel" fade>
        <h3 class="mb-4 text-center">PlayStation</h3>
      ...
      <section id="Xbox" class="tab-panel" fade>
        <h3 class="mb-4 text-center">Xbox</h3>
        <div class="flex flex-wrap items-center justify-center gap-8 overflow-hidden">
          {#each games as release}
      ...
      <section id="Nintendo" class="tab-panel" fade>
        <h3 class="mb-4 text-center">Nintendo</h3>
        <div class="flex flex-wrap items-center justify-center gap-8 overflow-hidden">
          {#each games as release}
