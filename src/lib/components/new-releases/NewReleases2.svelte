...
<div class="flex gap-8 flex-wrap justify-center items-center overflow-hidden">
 ...
 <section id="new-releases" class="flex flex-col gap-4 pt-16 prose lg:prose-xl prose-p:text-black prose-ol:text-black prose-strong:text-black prose-black
	prose-ul:text-black prose-ul:text-xl">
    <h2 class="text-center mb-8">New Releases</h2>
     <div>
